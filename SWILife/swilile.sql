...
CREATE TABLE `joborder` (
  ...
  `InternalNotes` varchar(4000) CHARACTER SET utf8 DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='It''s for authentication. Password is md5 of raw_pass+ salt ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `staffuser` VALUES (1,'root','123456a@','123456a@'),(2,'admin','123456a@','123456a@');
