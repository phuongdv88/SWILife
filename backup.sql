...
INSERT INTO `company` VALUES (1,'Swilife','01228800899','11111111','2222222','PVD','Vietnam','swilife.com','CNTT','FULL time','tuyển dụng ','A',1,'MiscNotes1','Hanoi','Hanoi_state','80000','HR',1,'2017-11-26',' ',1,1,'2017-11-26 00:00:00','2017-11-26 00:00:00'),(2,'com Name','1111','2222','33333','Com address','Vietnam','company.com.vn','com tech','com service ','com industy','B',0,'com misc','HCM','HCM','90000','CNTT',0,'2017-10-10',' ',2,1,'2017-11-26 00:00:00','2017-11-26 00:00:00');
...
INSERT INTO `contact` VALUES (1,'Nguyễn ','Văn','Tèo','CentiryLink','Talent Acquisition Manager','HR','(None)',1,'leo@email.com','leo@email2.com','6596855766','123456789','12345699','Phạm Văn Đông','Hà Nội','HN state','10000','https://link','Misc notes',1,1,'2017-06-12 00:00:00','2017-06-13 00:00:00','\"\"');
...
INSERT INTO `joborder` VALUES (1,'C++ senior','R&D','2000$',1,1,'HN','HN',1,1,'2017-06-12','2 years','H',5,1,1,'des','inter notes','','2017-06-12 00:00:00','2017-06-12 00:00:00','https://swilife.com/link1','Activate',NULL),(2,'Sale','PR','1500$',2,2,'HCM','HCM',2,2,'2017-12-25','3 years','H',2,1,1,'desc','inter','\\\\192.168.1.200\\d\\swilifedata\\joborder\\attachment\\2_2017-12-172RWGIrkTSw\\SWILifeApp.docx','2017-12-17 00:00:00','2017-12-17 00:00:00','https://swilife.com/link2','Lead',NULL);
...
INSERT INTO `runningtask` VALUES (14,2,1,'Not Contact',0,'2017-12-27 00:09:42','phuongdv',0),(16,2,2,'Not Contact',0,'2017-12-27 00:27:35','phuongdv',0),(17,1,1,'Not Contact',0,'2017-12-27 01:13:15','phuongdv',0);
...
select distinct T1.RunningTaskId, T1.CandidateId,T2.FirstName, T2.MiddleName, T2.LastName, T2.City, T1.Status, T1.Match, date_format(T1.Added, '%d-%m-%Y') as Added,
 T1.EnteredBy, concat(date_format(T3.Created, '%d-%m-%Y'),' (',T4.UserName, '): ', T3.Type) as LastActivity
...
-- Dump completed on 2017-12-27  1:17:14
